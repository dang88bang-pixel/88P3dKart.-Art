...
- **Python: 122/122 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 157 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
