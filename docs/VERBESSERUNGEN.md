...
- **Python: 137/137 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 167 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
