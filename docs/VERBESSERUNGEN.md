...
- **Python: 44/44 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 77 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
