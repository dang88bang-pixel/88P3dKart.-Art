...
- **Python: 76/76 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 118 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
