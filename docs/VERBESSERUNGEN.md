...
- **Python: 65/65 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 104 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
