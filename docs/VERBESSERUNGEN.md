...
- **Python: 144/144 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 172 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
