...
- **Python: 111/111 Tests grün** (u. a. Ausreißer-Szenario, Median/Kalman-Filter, RTI-Glättung).
- **Kotlin: 148 JVM-Unit-Tests** (gespiegelte Szenarien, Ausführung in Android Studio/CI).
